 ...
 * of this value object you may modify the generated sub-class of this class - LeagueAdminDAO.as.
 */
...
[ExcludeClass]
public class _Super_LeagueAdminDAO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dao.LeagueAdminDAO") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dao.LeagueAdminDAO", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _LeagueAdminDAOEntityMetadata;
    ...
    public function _Super_LeagueAdminDAO()
    {
        _model = new _LeagueAdminDAOEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _LeagueAdminDAOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _LeagueAdminDAOEntityMetadata) : void
    {
        var oldValue : _LeagueAdminDAOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
