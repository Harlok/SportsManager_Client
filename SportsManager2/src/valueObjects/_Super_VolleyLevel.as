 ...
 * of this value object you may modify the generated sub-class of this class - VolleyLevel.as.
 */
...
[ExcludeClass]
public class _Super_VolleyLevel extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dto.VolleyLevel") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dto.VolleyLevel", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _VolleyLevelEntityMetadata;
    ...
    public function _Super_VolleyLevel()
    {
        _model = new _VolleyLevelEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _VolleyLevelEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _VolleyLevelEntityMetadata) : void
    {
        var oldValue : _VolleyLevelEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
