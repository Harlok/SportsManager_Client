 ...
 * of this value object you may modify the generated sub-class of this class - LeagueSeason.as.
 */
...
[ExcludeClass]
public class _Super_LeagueSeason extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dto.LeagueSeason") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dto.LeagueSeason", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _LeagueSeasonEntityMetadata;
    ...
    public function _Super_LeagueSeason()
    {
        _model = new _LeagueSeasonEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get defaultLocation() : valueObjects.Location
    {
    ...
    public function set league(value:valueObjects.League) : void
    {
        var oldValue:valueObjects.League = _internal_league;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _LeagueSeasonEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _LeagueSeasonEntityMetadata) : void
    {
        var oldValue : _LeagueSeasonEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
