 ...
 * of this value object you may modify the generated sub-class of this class - League.as.
 */
...
[ExcludeClass]
public class _Super_League extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dto.League") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dto.League", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _LeagueEntityMetadata;
    ...
    public function _Super_League()
    {
        _model = new _LeagueEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get organization() : valueObjects.Organization
    {
    ...
    public function set organization(value:valueObjects.Organization) : void
    {
        var oldValue:valueObjects.Organization = _internal_organization;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _LeagueEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _LeagueEntityMetadata) : void
    {
        var oldValue : _LeagueEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
