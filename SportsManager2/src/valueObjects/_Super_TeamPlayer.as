 ...
 * of this value object you may modify the generated sub-class of this class - TeamPlayer.as.
 */
...
[ExcludeClass]
public class _Super_TeamPlayer extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dto.TeamPlayer") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dto.TeamPlayer", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _TeamPlayerEntityMetadata;
    ...
    private var _internal_playerId : int;
    private var _internal_role : int;
    ...
    public function _Super_TeamPlayer()
    {
        _model = new _TeamPlayerEntityMetadata(this);
    ...
    {
        var oldValue:int = _internal_playerId;
        if (oldValue !== value)
        {
            _internal_playerId = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "playerId", oldValue, _internal_playerId));
        }
    }

    public function set role(value:int) : void
    {
        var oldValue:int = _internal_role;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TeamPlayerEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TeamPlayerEntityMetadata) : void
    {
        var oldValue : _TeamPlayerEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
