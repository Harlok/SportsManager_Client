...
[ExcludeClass]
internal class _LevelInterestDAOEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var entityName:String = "LevelInterestDAO";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();
    model_internal static var propertyTypeMap:Object;


    model_internal var _instance:_Super_LevelInterestDAO;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _LevelInterestDAOEntityMetadata(value : _Super_LevelInterestDAO)
    {
        ...
        model_internal::propertyTypeMap["maxLevel"] = "valueObjects.VolleyLevelDAO";
        model_internal::propertyTypeMap["player"] = "valueObjects.PlayerDAO";
        model_internal::propertyTypeMap["minLevel"] = "valueObjects.VolleyLevelDAO";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity LevelInterestDAO");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity LevelInterestDAO");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of LevelInterestDAO");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity LevelInterestDAO");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity LevelInterestDAO");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isMinLevelAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get minLevelStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
