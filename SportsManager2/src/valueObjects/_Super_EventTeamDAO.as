 ...
 * of this value object you may modify the generated sub-class of this class - EventTeamDAO.as.
 */
...
[ExcludeClass]
public class _Super_EventTeamDAO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dao.EventTeamDAO") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dao.EventTeamDAO", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _EventTeamDAOEntityMetadata;
    ...
    public function _Super_EventTeamDAO()
    {
        _model = new _EventTeamDAOEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _EventTeamDAOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _EventTeamDAOEntityMetadata) : void
    {
        var oldValue : _EventTeamDAOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
