 ...
 * of this value object you may modify the generated sub-class of this class - TeamPlayerDAO.as.
 */
...
[ExcludeClass]
public class _Super_TeamPlayerDAO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dao.TeamPlayerDAO") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dao.TeamPlayerDAO", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _TeamPlayerDAOEntityMetadata;
    ...
    public function _Super_TeamPlayerDAO()
    {
        _model = new _TeamPlayerDAOEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TeamPlayerDAOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TeamPlayerDAOEntityMetadata) : void
    {
        var oldValue : _TeamPlayerDAOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
