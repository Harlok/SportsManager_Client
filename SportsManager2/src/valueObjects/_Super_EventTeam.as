 ...
 * of this value object you may modify the generated sub-class of this class - EventTeam.as.
 */
...
[ExcludeClass]
public class _Super_EventTeam extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dto.EventTeam") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dto.EventTeam", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _EventTeamEntityMetadata;
    ...
    public function _Super_EventTeam()
    {
        _model = new _EventTeamEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _EventTeamEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _EventTeamEntityMetadata) : void
    {
        var oldValue : _EventTeamEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
