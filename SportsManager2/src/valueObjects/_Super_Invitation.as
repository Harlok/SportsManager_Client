 ...
 * of this value object you may modify the generated sub-class of this class - Invitation.as.
 */
...
[ExcludeClass]
public class _Super_Invitation extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dto.Invitation") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dto.Invitation", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _InvitationEntityMetadata;
    ...
    public function _Super_Invitation()
    {
        _model = new _InvitationEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get toPlayer() : valueObjects.Player
    {
    ...
    public function set toPlayer(value:valueObjects.Player) : void
    {
        var oldValue:valueObjects.Player = _internal_toPlayer;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _InvitationEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _InvitationEntityMetadata) : void
    {
        var oldValue : _InvitationEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
