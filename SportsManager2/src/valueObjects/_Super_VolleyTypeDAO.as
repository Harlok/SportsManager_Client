 ...
 * of this value object you may modify the generated sub-class of this class - VolleyTypeDAO.as.
 */
...
[ExcludeClass]
public class _Super_VolleyTypeDAO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dao.VolleyTypeDAO") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dao.VolleyTypeDAO", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _VolleyTypeDAOEntityMetadata;
    ...
    model_internal var _internal_interestedPlayers_leaf:valueObjects.LevelInterestDAO;
    ...
    public function _Super_VolleyTypeDAO()
    {
        _model = new _VolleyTypeDAOEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _VolleyTypeDAOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _VolleyTypeDAOEntityMetadata) : void
    {
        var oldValue : _VolleyTypeDAOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
