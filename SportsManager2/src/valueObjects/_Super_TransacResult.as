 ...
 * of this value object you may modify the generated sub-class of this class - TransacResult.as.
 */
...
[ExcludeClass]
public class _Super_TransacResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dto.TransacResult") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dto.TransacResult", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _TransacResultEntityMetadata;
    ...
    public function _Super_TransacResult()
    {
        _model = new _TransacResultEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TransacResultEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TransacResultEntityMetadata) : void
    {
        var oldValue : _TransacResultEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
