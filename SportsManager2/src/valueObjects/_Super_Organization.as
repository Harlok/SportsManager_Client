...
public class _Super_Organization extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dto.Organization") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dto.Organization", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _internal_leagueList_leaf:valueObjects.League;
