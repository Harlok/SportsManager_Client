...
[ExcludeClass]
internal class _SeasonEventEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("location", "teamInvitations", "leagueSeason", "setTime", "setPoints", "setCount", "capOn15", "capOn21", "timePerPoint", "capOn25", "maxPlayerPerPool", "date", "setConfig", "poolCount", "id", "startTime", "scheduleLocked", "courtCount", "matchList", "teamPosList");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("location", "teamInvitations", "leagueSeason", "setTime", "setPoints", "setCount", "capOn15", "capOn21", "timePerPoint", "capOn25", "maxPlayerPerPool", "date", "setConfig", "poolCount", "id", "startTime", "scheduleLocked", "courtCount", "matchList", "teamPosList");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("location", "teamInvitations", "leagueSeason", "setTime", "setPoints", "setCount", "capOn15", "capOn21", "timePerPoint", "capOn25", "maxPlayerPerPool", "date", "setConfig", "poolCount", "id", "startTime", "scheduleLocked", "courtCount", "matchList", "teamPosList");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("location", "teamInvitations", "leagueSeason", "setTime", "setPoints", "setCount", "capOn15", "capOn21", "timePerPoint", "capOn25", "maxPlayerPerPool", "date", "setConfig", "poolCount", "id", "startTime", "scheduleLocked", "courtCount", "matchList", "teamPosList");
    ...
    model_internal static var entityName:String = "SeasonEvent";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();
    model_internal static var propertyTypeMap:Object;


    model_internal var _instance:_Super_SeasonEvent;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _SeasonEventEntityMetadata(value : _Super_SeasonEvent)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::collectionBaseMap["teamInvitations"] = "valueObjects.Invitation";
            model_internal::collectionBaseMap["matchList"] = "valueObjects.EventMatch";
            model_internal::collectionBaseMap["teamPosList"] = "valueObjects.EventTeam";
        }
        ...
        model_internal::propertyTypeMap["leagueSeason"] = "valueObjects.LeagueSeason";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity SeasonEvent");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity SeasonEvent");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of SeasonEvent");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity SeasonEvent");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity SeasonEvent");
        }
