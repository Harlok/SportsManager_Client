 ...
 * of this value object you may modify the generated sub-class of this class - SeasonEventDAO.as.
 */
...
[ExcludeClass]
public class _Super_SeasonEventDAO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.sportsmanager.model.dao.SeasonEventDAO") == null)
            {
                flash.net.registerClassAlias("com.sportsmanager.model.dao.SeasonEventDAO", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _SeasonEventDAOEntityMetadata;
    ...
    model_internal var _internal_teamInvitations_leaf:valueObjects.InvitationDAO;
    private var _internal_matchList : ArrayCollection;
    model_internal var _internal_matchList_leaf:valueObjects.EventMatchDAO;
    private var _internal_teamPosList : ArrayCollection;
    model_internal var _internal_teamPosList_leaf:valueObjects.EventTeamDAO;
    ...
    public function _Super_SeasonEventDAO()
    {
        _model = new _SeasonEventDAOEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get location() : valueObjects.LocationDAO
    {
    ...
    [Bindable(event="propertyChange")]
    public function get leagueSeason() : valueObjects.LeagueSeasonDAO
    {
    ...
    public function set location(value:valueObjects.LocationDAO) : void
    {
        var oldValue:valueObjects.LocationDAO = _internal_location;
        if (oldValue !== value)
        {
    ...
    public function set leagueSeason(value:valueObjects.LeagueSeasonDAO) : void
    {
        var oldValue:valueObjects.LeagueSeasonDAO = _internal_leagueSeason;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _SeasonEventDAOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _SeasonEventDAOEntityMetadata) : void
    {
        var oldValue : _SeasonEventDAOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
